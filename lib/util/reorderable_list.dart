//Taken from https://github.com/knopp/flutter_reorderable_list/blob/f4379a063848c34f94bcf0e581d3be70c87f1d93/lib/flutter_reorderable_list.dart
//Using the push request that allows the disabling of the drop shadow contributed by nuc134r. Library by knopp.
    ...
    if (closest != null &&
      ...
      if (widget.onReorder != null) {
        if (widget.onReorder(_dragging, closest.key)) {
          _hapticFeedback(); //Disable this to stop feedback when moving through elements.
